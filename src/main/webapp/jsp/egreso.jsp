...
<body>
    ...
    <%@include file = '../templates/banner.jsp' %> 
     ...
     <!-- REGISTRAR UN EGRESO -->
    <br> <br>
    <p class="h3 ms-5">REGISTRO DE EGRESOS</p>
    <br>
    
    
     <div class="d-flex justify-content-center">

        <form class="registro" action="GestionCuentaController?ruta=egreso" method="POST">
            ...
            <div class="mb-3">
                <label for="Descripcion" class="form-label">DESCRIPCIÓN DEL EGRESO</label>
            ...
            <div class="mb-3">
                ...
                <label for="montoEgreso" class="form-label">MONTO</label>
                <div class="d-flex align-items-center">
                    <i class="fa fa-dollar-sign trailing me-2"></i>
                    <input type="number" min="0.1" id="montoEgreso" name="monto" class="form-control"
                        placeholder="Monto" step="0.1" required>
                </div>

            </div>
            <br>
            <button type="submit" class="btn bg-1 text-white font-w700">REGISTRAR EGRESO</button>
        </form>
    </div>
